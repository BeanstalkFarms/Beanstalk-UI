      ...
      <Box className="App">
        ...
        <Dialog fullScreen={false} open={open}>
          ...
          <DialogContent>
            ...
            <p>Be wary of scams as Beanstalk approaches Replant. <ul><li>The latest Beanstalk UI is hosted on <strong>app.bean.money</strong>.</li><li>The pre-exploit Beanstalk UI is hosted on <strong>pre-exploit-beanstalk-ui.netlify.app</strong></li><li>No one from Beanstalk Farms will DM you first. All official links flow through <strong>#announcements in Discord</strong>.</li></ul></p>
          </DialogContent>
          <DialogActions>
