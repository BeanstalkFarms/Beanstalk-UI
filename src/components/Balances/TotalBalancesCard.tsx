    ...
    <Box>
      ...
      {account && chainId === SupportedChainId.MAINNET && (
        <Alert severity="warning" sx={{ mt: 2, mb: 1 }}>
          ...
          Balances are currently fixed to their pre-exploit values. The USD
          value of Silo Deposits are calculated using a fixed $BEAN price of{' '}
          <strong>$1.02027</strong>.<br />
          Due to upgrades to the Beanstalk contract and website infrastructure,
          pre-exploit balances may be temporarily hidden or show incorrect
          values for some users. Please report issues in{' '}
          <strong>#ui-feedback</strong> and stay tuned for updates in{' '}
          <strong>#ui-updates</strong> on{' '}
          <Link href="https://discord.gg/beanstalk">Discord</Link>. Upgrades
          will continue to happen between now and Replant.
        </Alert>
      )}
