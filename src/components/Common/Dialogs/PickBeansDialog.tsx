...
import { BEAN_CRV3_LP, BEAN_ETH_UNIV2_LP, BEAN_LUSD_LP } from 'constants/tokens';
...
// CB - this should get you started building this page. You can loop
// through the below 2 arrays to build the page content.
// Note: the `unripe` state variable in `PickBeansDialog` is an object
// which, for each of the below keys (like 'circulatingBeans'):
//  - if unripe[key] is set, its the amount of the respective token
//  - if unripe[key] is not set, the amount is zero
// you got this
  ...
  const tab0 = (
    <>
      ...
      <StyledDialogContent>
        <Stack gap={2}>
          {/* Pod Balance */}
          <Typography color="text.secondary">Unripe Beans represent a pro rata share of underlying Beans that are minted as Fertilizer is sold and debt is repaid to Fertilizer.
          </Typography>
          <Card sx={{ p: 2 }}>
