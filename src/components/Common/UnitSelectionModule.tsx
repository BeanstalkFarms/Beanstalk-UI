...
UnitSelectionModule.defaultProps = {
  ...
  beanEthereum: true,
  beanEthereumDescription: 'Bean Ethereum Mode: Use both Beans and Ethereum in tx',
  beanEthereumSwap: false,
  beanEthereumSwapDescription: 'Bean Ethereum Mode: Use both Beans and Ethereum in tx',
  ethereum: true,
