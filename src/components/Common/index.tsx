...
export const siloStrings = {
  ...
  thirtyDayInterestDescription: 'The total number of Beans paid to depositors over the last 30 days.',
  ...
  myOwnershipDescription: 'Your percent ownership of the Silo. You will receive this percentage of all new Beans minted to depositors.',
