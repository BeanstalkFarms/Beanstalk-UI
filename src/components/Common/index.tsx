...
export const walletDescriptions = {
  ...
  stalkBalance: 'Your total Stalk Balance. Stalk are the ownership token of the Beanstalk DAO. Stalk entitles you to vote on BIPs and a portion of new Bean mints. Your Stalk is forfeited when you Withdraw your Deposited assets from the Silo.',
  ...
  topLeft: 'The total USD calue of Beans and LP Tokens. This total does not include your Pods or ETH.',
  topLeftTitle: 'Bean Balance',
  topRight: 'Your current ownership of Beanstalk as a percent. Ownership is determined by your proportional ownership of Stalk.',
...
export const totalDescriptions = {
  ...
  stalkBalance: 'The total current number of Stalk. Stalk are the ownership token of the Beanstalk DAO. Stalk entitles holders to vote on BIPs and a portion of new Bean mints. Stalk is forfeited upon Withdrawal of Deposited assets from the Silo.',
