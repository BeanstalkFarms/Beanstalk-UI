...
export const siloStrings = {
  ...
  thirtyDayInterestDescription: 'The total number of Beans paid to Silo Members over the last 30 days.',
  ...
  myOwnershipDescription: 'Your percent ownership of the Silo. You will receive this percentage of all new Beans minted to Silo Members.',
