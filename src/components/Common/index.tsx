...
export const fieldStrings = {
  ...
  harvest: 'Use this tab to Harvest Pods. You can also toggle the "Claim" setting on in the Silo or Field modules to Harvest and use your Pods in a single transaction.',
  sendPlotWarning: 'WARNING: There is currently no decentralized market for buying and selling Plots. Send Plots at your own risk.',
  availableSoil: 'Soil is the number of Beans that Beanstalk is currently willing to borrow. Anyone can lend any number of Beans up to the Available Soil in exchange for Pods.',
  podLine: 'The Pod Line is the total number of Unharvestable Pods. This is the amount of debt Beanstalk has outstanding.',
  weather: 'The Weather is the interest rate for sowing Beans. For a given Weather w, you receive w + 1 Pods for each Bean sown.',
  podsHarvested: 'The total Harvested Pods over all Seasons is the amount of debt Beanstalk has paid off thus far.',
  podAPY: 'The Pod APY is a rough estimate based on a liquidity weighted average of Beans minted over the previous 168 Seasons normalized to the current liquidity. For the complete formulas used to calculate APY,',
  seasonsToPodClearance: 'The Seasons to Pod Clearance is a rough estimate based on a liquidity weighted average of Beans minted over the previous 168 Seasons normalized to the current liquidity. For the complete formulas used to calculate Seasons to Pod Clearance,',
};
export const siloStrings = {
  beanDeposit: 'Use this sub-tab to deposit Beans to the Silo. You can toggle the settings to deposit from Beans, ETH, or both.',
  beanWithdraw: 'Use this sub-tab to withdraw Beans from the Silo. Withdrawals will be claimable 24 full Seasons after withdrawal.',
  ...
  beanAPY: 'The Bean APY is a rough estimate based on a liquidity weighted average of Beans minted over the previous 168 Seasons normalized to the current liquidity. For the complete formulas used to calculate APY,',
  lpDeposit: 'Use this sub-tab to deposit LP Tokens to the Silo. You can toggle the settings to deposit from Beans, ETH, or both and to convert Deposited Beans to Deposited LP Tokens.',
  lpWithdraw: 'Use this sub-tab to withdraw LP Tokens from the Silo. Withdrawals will be claimable 24 full Seasons after withdrawal.',
...
export const tradeStrings = {
  ...
  tradeDescription: 'Anyone can buy and sell Beans on Uniswap directly through the bean.money website. To buy and deposit or buy and sow in a single transaction from ETH, use the Silo and Field modules, respectively.',
};
export const governanceStrings = {
  bips: 'Below is a complete list of all historical BIPs.',
  activeBips: 'Active Beanstalk Improvement Proposals currently being voted on.',
  governanceDescription: 'Beanstalk is upgraded in a decentralized fashion through Beanstalk Improvement Proposals (BIPs). Anyone with more than .1% of the total outstanding Stalk can propose a BIP. Any Stalk holder can vote for a BIP. BIPs can be committed in as little as 24 Seasons with a 2/3 supermajority, or after 168 Seasons with a 1/2 majority.',
};
