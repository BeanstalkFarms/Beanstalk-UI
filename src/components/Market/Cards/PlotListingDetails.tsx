...
import { Stack, Typography, Card, Box, CardProps } from '@mui/material';
        ...
        <Stack direction="row" justifyContent="space-between">
          <Stack gap={0.5}>
            ...
            <Typography variant="bodyLarge">
              {displayBN(
                new BigNumber(podListing.index).minus(harvestableIndex)
              )}
            </Typography>
          </Stack>
          <Stack gap={0.5}>
          ...
          <Stack gap={0.5}>
            ...
            <Stack direction="row" gap={0.3} alignItems="center">
              ...
              <Typography variant="bodyLarge">
                {displayBN(podListing.filledAmount)}/
                {displayBN(podListing.totalAmount)}
              </Typography>
            </Stack>
          </Stack>
        </Stack>
