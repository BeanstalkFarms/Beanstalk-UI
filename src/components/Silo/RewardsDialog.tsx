...
const options = [
  ...
  },
  {
    title: 'Plant',
    description:
      'Add Plantable Seeds to your Seed balance. Also Mows Grown Stalk.',
    value: ClaimRewardsAction.PLANT_AND_MOW,
  },
  {
    title: 'Enroot',
    description:
      'Add Revitalized Stalk and Seeds to your Stalk and Seed balances. Also Mows Grown Stalk.',
    value: ClaimRewardsAction.ENROOT_AND_MOW,
  },
  {
    title: 'Claim all Silo rewards',
    description:
      'Add all Stalk and Seed rewards to your Stalk and Seed balances.',
...
const ClaimRewardsForm: React.FC<
  FormikProps<ClaimRewardsFormValues> & RewardsBarProps
> = ({ submitForm, isSubmitting, values, ...rewardsBarProps }) => {
  ...
  return (
    <>
      <StyledDialogContent sx={{ pb: 0 }}>
        <Stack gap={1.5}>
          <Box px={1} py={0.5}>
            <RewardsBar compact {...rewardsBarProps} />
          </Box>
          <Field name="action">
    ...
    async (
      ...
      try {
        ...
        if (values.action === ClaimRewardsAction.MOW) {
          ...
          const encodedDataByToken = encodeCratesForEnroot(
            beanstalk,
            unripeTokens,
            siloBalances
          );
    ...
    <Dialog onClose={handleClose} open={open} fullWidth maxWidth="md">
      ...
      <Formik initialValues={initialValues} onSubmit={onSubmit}>
        {(formikProps: FormikProps<ClaimRewardsFormValues>) => (
          <ClaimRewardsForm {...formikProps} {...rewardsBarProps} />
        )}
      </Formik>
    </Dialog>
  );
