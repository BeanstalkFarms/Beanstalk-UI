      ...
      >
        <Grid container alignItems="flex-end">
          ...
          <Grid
            ...
            sx={{
              textAlign: 'right',
              paddingRight: `${ARROW_CONTAINER_WIDTH}px`,
            }}
          >
                ...
                <Grid container alignItems="center">
                  ...
                  >
                    <Tooltip
                      title={
                        <>
                          BDV per {token.symbol}: {displayFullBN(getBDV(token))}{' '}
                          BEAN
                        </>
                      }
                    >
                      <Typography color="black">
                        ...
                        {token.rewards?.stalk} &nbsp;
                        <TokenIcon token={SEEDS} style={{ marginTop: 1.5 }} />
                        {token.rewards?.seeds}
                      </Typography>
                    </Tooltip>
                  </Grid>
                  ...
                  <Grid item md={1.5} xs={8}>
                    ...
                    >
                      <Typography color="black">
                        {deposited?.amount
                          ? displayUSD(poolTokenToUSD(token, deposited.amount))
                          : '$0'}
                      </Typography>
                      <Stack
