  ...
  return (
    <ContentSection id='trade' title='Trade'>
      <Grid container item xs={12} spacing={3} justifyContent='center'>
        <Grid className={"section-description"} item xs={12} sm={12} style={width > 700 ? {maxWidth: '500px', margin: '20px 0', padding: '12px'} : {maxWidth: '400px', width: width - 154, margin: '20px 0', padding: '12px', midWidth: width - 104}}>
