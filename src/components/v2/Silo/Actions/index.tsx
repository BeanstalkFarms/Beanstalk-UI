...
//   constructor(_data: (typeof SwapInstruction)['prototype']['data']) {
//     this.data = _data;
//   }

//   toString() {
//     return `Swap ${displayFullBN(this.data.amountIn)} ${this.data.tokenIn} for ${displayFullBN(this.data.amountOut)} ${this.data.tokenOut}.`
//   }
// }

// class DepositInstruction implements Instruction {
//   public readonly data : {
//     amountIn: BigNumber;
//     tokenIn: Token;
//   };

//   constructor(_data: (typeof DepositInstruction)['prototype']['data']) {
//     this.data = _data;
//   }

//   toString() {
//     return `Deposit ${displayFullBN(this.data.amountIn)} ${this.data.tokenIn} into the Silo.`
//   }
// }

// class RewardsInstruction implements Instruction {
//   public readonly data : {
//     stalk: BigNumber;
//     seeds: BigNumber;
//   };

//   constructor(_data: (typeof RewardsInstruction)['prototype']['data']) {
//     this.data = _data;
//   }

//   toString() {
//     return `Receive ${displayFullBN(this.data.stalk)} Stalk and ${this.data.seeds} Seeds.`
//   }
// }
