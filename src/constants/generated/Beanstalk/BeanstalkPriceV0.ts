...
export declare namespace BeanstalkPrice {
  ...
  export type PricesStructOutput = [
    ...
    BigNumber,
    BigNumber,
    [P.PoolStructOutput, P.PoolStructOutput]
  ] & {
    price: BigNumber;
    liquidity: BigNumber;
    deltaB: BigNumber;
    ps: [P.PoolStructOutput, P.PoolStructOutput];
  };
}

export interface BeanstalkPriceV0Interface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getCurve" | "getUniswap" | "price"
  ): FunctionFragment;
...
export interface BeanstalkPriceV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BeanstalkPriceV0Interface;
