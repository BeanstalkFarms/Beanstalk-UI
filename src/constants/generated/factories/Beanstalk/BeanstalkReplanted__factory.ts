...
import type {
  BeanstalkReplanted,
  BeanstalkReplantedInterface,
} from "../../Beanstalk/BeanstalkReplanted";
...
export class BeanstalkReplanted__factory {
  static readonly abi = _abi;
  static createInterface(): BeanstalkReplantedInterface {
    return new utils.Interface(_abi) as BeanstalkReplantedInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BeanstalkReplanted {
    return new Contract(address, _abi, signerOrProvider) as BeanstalkReplanted;
  }
}
