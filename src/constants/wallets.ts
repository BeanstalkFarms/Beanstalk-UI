...
export const CONNECT_WALLET_ERRORS: {
  ...
  UserRejectedRequestError: () =>
    'The connection was cancelled while in progress. Try connecting again.',
  'Already processing eth_requestAccounts. Please wait.': (c) =>
    `Connection already in progress. Try unlocking ${
      c?.name || 'your wallet'
    } to allow Beanstalk to connect.`,
};
...
export const SWITCH_NETWORK_ERRORS: {
  ...
  UserRejectedRequestError: () =>
    'The switch was cancelled while in progress. Try switching again.',
};
