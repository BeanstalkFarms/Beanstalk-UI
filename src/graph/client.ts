...
export const sgEnvKey =
  store.getState().app.settings.subgraphEnv || SGEnvironments.BF_PROD;
export const sgEnv =
  SUBGRAPH_ENVIRONMENTS[sgEnvKey] ||
  SUBGRAPH_ENVIRONMENTS[SGEnvironments.BF_PROD];
