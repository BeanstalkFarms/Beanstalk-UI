...
export const PRE_EXPLOIT_BEAN_DATA = {
  ...
  updateBeanPrice: new BigNumber(1.02027),
  ...
  updateBeanPools: [
    {
      ...
      pool: {
        ...
        supply: tokenResult(BEAN_ETH_UNIV2_LP)(
          new BigNumber(540894218294675521)
        ),
    ...
    },
    {
      ...
      pool: {
        ...
        supply: tokenResult(BEAN_CRV3_LP)(
          new BigNumber(79284313822927052565331157)
        ),
    ...
    },
    {
      ...
      pool: {
        ...
        supply: tokenResult(BEAN_LUSD_LP)(
          new BigNumber(1637956191657208904972868)
        ),
...
export const useGetPools = () => {
    ...
    try {
      if (beanstalkPriceContract) {
        ...
        if (chainId === SupportedChainId.MAINNET) {
          ...
          console.debug(
            '[bean/pools/useGetPools] OVERRIDE: using pre-exploit data'
          );
          return;
        }
        ...
        const [priceResult, beanSupply] = await Promise.all([
        ...
        dispatch(
          updateBeanPrice(tokenResult(BEAN)(priceResult.price.toString()))
        );
  ...
  }, [dispatch, beanstalkPriceContract, chainId]);
