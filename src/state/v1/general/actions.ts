...
export const setBips = createAction<any[]>(
  'general/setBips'
);

export const setContractEvents = createAction<any[]>(
...
export const setFundraisers = createAction<any[]>('general/setFundraisers');
