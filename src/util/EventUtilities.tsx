...
export async function initializeEventListener(callback, updatePrices, updateTotals, setContractEvents) {
  ...
  var accountEvents = await Promise.all([
                                          beanstalk.getPastEvents('BeanDeposit', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('BeanRemove', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('BeanWithdraw', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('LPDeposit', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('LPRemove', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('LPWithdraw', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('Sow', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('Harvest', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('BeanClaim', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('LPClaim', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('Proposal', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('Vote', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('Unvote', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('EtherClaim', {filter: {account: account},fromBlock:0}),
                                          beanstalk.getPastEvents('PlotTransfer', {filter: {from: account},fromBlock:0}),
                                          beanstalk.getPastEvents('PlotTransfer', {filter: {to: account},fromBlock:0})
                                        ])
  var allEvents = [].concat.apply([], accountEvents);
