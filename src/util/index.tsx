...
import { BEANFT, BEANSTALK, UNISWAP_V2_ROUTER, changeNetwork } from '../constants'
...
export const tokenContract = (token) => ( new ethers.Contract(token.addr, beanAbi, web3Signer) )
export const tokenContractReadOnly = (token) => ( new web3.eth.Contract(beanAbi, token.addr) )

export const beanstalkContract = () => ( new ethers.Contract(BEANSTALK.addr, beanstalkAbi, web3Signer) )
export const beanstalkContractReadOnly = () => ( new web3.eth.Contract(beanstalkAbi, BEANSTALK.addr) )

export const beaNFTContract = () => (new ethers.Contract(BEANFT.addr, beaNFTAbi, web3Signer))
export const beaNFTContractReadOnly = () => ( new web3.eth.Contract(beaNFTAbi, BEANFT.addr) )

export const pairContract = (pair) => ( new ethers.Contract(pair.addr, uniswapPairAbi, web3Signer) )
export const pairContractReadOnly = (pair) => ( new web3.eth.Contract(uniswapPairAbi, pair.addr) )

export const uniswapRouterContract = () => ( new ethers.Contract(UNISWAP_V2_ROUTER, uniswapRouterAbi, web3Signer) )
